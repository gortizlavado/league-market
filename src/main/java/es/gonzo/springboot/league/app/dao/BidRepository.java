...
public interface BidRepository extends CrudRepository<Bid, Long> {
    ...
    Optional<BidJoin> findByPlayerIdAndIdUserBidAndCommunityAndSeason(Long idPlayer, Long idUserBid, Long idCommunity, String seasonId);
    ...
    Set<BidJoin> findByIdUserBidAndCommunityAndSeason(Long idUserBid, Long idCommunity, String seasonId);
    ...
    Set<BidJoin> findByIdUserBidAndIdCommunityAndSeasonAndStatus(Long idUserBid, Long idCommunity, String seasonId, TransactionStatus status);
}
